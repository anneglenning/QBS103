...
## Histogram 
```{r}
histogram <- function(df, genes, cont_cov, cate_cov1, cate_cov2) {
...
#histogram(NULL, gene_data$AAGAB, NULL, NULL, NULL)
histogram(NULL, list(gene_data$AAGAB, gene_data$AACS, gene_data$AAK1), NULL, NULL, NULL)
```


## Scatterplot 
```{r}
scatterplot <- function(df, genes, cont_cov, cate_cov1, cate_cov2) {
  ...
  labs( # labeling the title and axis 
    title = paste0("Scatterplot of the ", gene_names[tracker],
                   " Expression Levels vs. ", cont_cov_string), 
...
scatterplot(series_data, list(gene_data$AAGAB, gene_data$AACS, gene_data$AAK1), 
...
box_plot <- function(df, genes, cont_cov, cate_cov1, cate_cov2) {
  ...
  geom_boxplot() +
  labs( # labeling the title and axis 
    title = paste0("Box Plot of ", gene_names[tracker],
          " Expression Levels by ", cate_cov1_string, " and ", cate_cov2_string),
    x = cate_cov1_string, 
...
box_plot(series_data, list(gene_data$AAGAB, gene_data$AACS, gene_data$AAK1), NULL, 
         series_data$icu_status, series_data$sex)
```
